...
if el_version >= 7
  ...
  node.set['mysql']['server']['packages-additional'] = ['Percona-Server-server-56', 'Percona-Server-devel-56']
  ...
  node.set['mysql']['client']['packages-additional'] = ['Percona-Server-client-56', 'Percona-Server-devel-56']
